...
10. To test if everything is right, open SEGGER and click “Target”->”Connect J-Link”. SEGGER should connect to your SDK

11. To flash your ruuvi tag with the cloned firmware, click “Target”->”Erase All”, afterwards click “Build”->”Build and Run”. 
...
6. Open Raspberry Pi imager and flash sd card.
...
10. Get your Raspberry’s IP-Adress by opening a command line on your PC and and type “ping raspberrypi.local”.
...
12. When asked for the username type “pi” and afterwards enter your password. If you did not change it on Raspberry’s startup it should be “raspberry”.

### How to setup Git on a Raspberry Pi

#### Installing Git
13. The Git package is included in the OS defaults of any Raspberry, therefore you can run the following code as admin user, called "root" on the Raspberry.
(`sudo apt update`)

14. to make sure you have the newest version and then type
(`sudo apt install git`)

15. Enter the command below to check whether the installation was succesful:
(`git --version`)

16. Output at time of writing this documentation:
(`git version 2.30.2`)

17. That’s it! You have installed Git on your Raspberry Pi.

#### First steps in using Git on Raspberry
18. To clone the Gateway repository (https://github.com/bchwtz-fhswf/gateway) onto your pi, you need a SSH Key which is connected to your account. Generate it by following the instructions in https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent for Linux (you dont have to pass it to a key agent) and add it to your account by following the instructions in https://docs.github.com/en/github/authenticating-to-github/adding-a-new-ssh-key-to-your-github-account 

19. Then, type the following into the PuTTY window connected to your raspberry. When asked, enter the SSH Key password you initiated while generating the key.
(`git clone git@github.com:bchwtz-fhswf/gateway.git`)

20. Now, switch to the correct path, where the repository was copied to.
(`cd gateway`)

21. Checkout a specific branch, with
(`git checkout branchname`)

22. Please replace "branchname" with an existing branch for example "develop". Therefore, you type
(`git checkout develop`)

23. If it worked well, you can tell by the console entry, which should look like that:
(`pi@raspberrypi ~/gateway (develop)>`)

24. Assuming you work some days later on the project, you have to make sure that you are always up to date on the newest changes. Therefore, type 
(`git pull`)

25. All changes are shown in console. If no changes are done, you get
(`Already up to date.`)


### Python modules

26. Before you are able to execute some of the scripts, you have to install some Python modules by typing or pasting the following commands. (You can paste into a PuTTY window by right-clicking) 
...
27. To try if your setup is working, navigate to the cloned repo and type “python3 GetConfigFromSensor.py”. You should see something like this:
![](./gfx/org/Test.png)

28. To properly use the gateway library, type “python3” into the putty command window. This activates an interactive python session. Type “import SensorGatewayCommunication“. Afterwards you can type
